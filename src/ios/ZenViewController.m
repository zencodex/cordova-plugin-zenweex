...
@interface ZenViewController () <UIScrollViewDelegate, UIWebViewDelegate>
...
- (void)_renderWithURL:(NSURL *)sourceURL
{
    ...
    [_instance renderWithURL:[NSURL URLWithString:newURL] options:@{@"bundleUrl":sourceURL.absoluteString, @"args": _args} data:nil];
